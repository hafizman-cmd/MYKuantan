                  ...
                  {photos.map((photo) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group relative w-full rounded-[2rem] overflow-hidden bg-[#1A4A7A] cursor-pointer transition-all duration-300 transform hover:scale-[1.01] ${isSelected
